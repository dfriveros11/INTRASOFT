...
public class ActivoFijoServiceTest {
	...
	public void crearActivoFijoMalTest() {
		...
		ActivoFijoDocument activoFijo = new ActivoFijoDocument.Builder("Prueba", "Maquinaria", "123", 1, 100, 100, 100,
				100, 986.000, ZonedDateConvertidor.convertZonedToDate(fechaCompra),
	...
	@Test(expected = IllegalArgumentException.class)
	public void crearActivoFijoConÁreaYPersonaTest() {
		LocalDateTime fecha = LocalDateTime.now(ZoneOffset.UTC);
		ZonedDateTime fechaBaja = ZonedDateTime.of(fecha, zona);
		ZonedDateTime fechaCompra = fechaBaja.plusMonths(2);
		...
		ActivoFijoDocument activoFijo = new ActivoFijoDocument.Builder("Prueba", "Maquinaria", "123", 1, 100, 100, 100,
				100, 986.000, ZonedDateConvertidor.convertZonedToDate(fechaCompra),
				ZonedDateConvertidor.convertZonedToDate(fechaBaja), "activo", "azul").área(área).persona(persona)
						.build();
		activoFijoService.crearActivoFijo(activoFijo);
		activoFijoRepository.deleteAll();
	}
